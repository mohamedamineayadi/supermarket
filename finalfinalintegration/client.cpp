...
client::client (int id,QString nom,QString prenom,QString sexe,int tel,QString mail)
{
  this->id=id;
  this->nom=nom;
  this->prenom=prenom;
...
bool client:: modifierclient (int id,QString nom,QString prenom,QString sexe,int tel,QString mail)
{
    QString res = QString :: number (id) ;
    QString res1 = QString :: number (tel) ;
